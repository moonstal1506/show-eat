...
public enum ExceptionCode {
	...
	INVALID_REGISTRATION_EXCEPTION(491, "입력 정보와 사업자 등록증 정보가 일치하지 않습니다."),
	CLOVA_OCR_EXCEPTION(492, "CLOVA OCR에서 예측하지 못한 에러가 발생했습니다."),
	BUSINESS_REGISTRATION_EXCEPTION(493, "국세청 사업자등록정보 진위확인에서 예측하지 못한 에러가 발생했습니다."),
	SSE_CONNECT_EXCEPTION(494, "SSE 연결 오류가 발생했습니다."),
