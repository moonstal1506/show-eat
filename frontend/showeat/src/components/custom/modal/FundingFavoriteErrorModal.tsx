...
/* Type */
interface FundingFavoriteErrorModalProps {
    errorCode: number;
}
...
function FundingFavoriteErrorModal(props: FundingFavoriteErrorModalProps) {
...
/* Export */
export default FundingFavoriteErrorModal;
